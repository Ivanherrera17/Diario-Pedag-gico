...
export default function App() {
  ...
  const handleRoleChange = (role: Role) => {
    ...
    if (role === Role.Publico && page === 'dashboard') {
  ...
  const renderPage = () => {
    switch (page) {
      case 'home':
        return <PostList posts={mockPosts} currentUser={currentUser} />;
      case 'ai_assistant':
        return <AIAssistant />;
      case 'dashboard':
        return currentUser.role === Role.Supervisor ? <SupervisorDashboard /> : <PostList posts={mockPosts} currentUser={currentUser} />;
      default:
        return <PostList posts={mockPosts} currentUser={currentUser} />;
    }
  };
